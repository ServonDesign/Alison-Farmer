...
gulp.task('hb', function () {
    ...
    return gulp.src(['./common/*.handlebars', './common/partials/*.handlebars'])
...
gulp.task('watchhbpartials', function() {
    var hbWatch = gulp.watch('./common/partials*.handlebars', ['hb']);
});

gulp.task('build', ['browserify', 'less']);
gulp.task('watch', ['watchify', 'watchLess', 'watchhb', 'watchhbpartials']);
